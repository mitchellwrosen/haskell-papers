...
var _user$project$Main$viewPaper = F2(
		...
		return A2(
			...
			{ctor: '[]'},
			{
				...
				_0: function () {
					var _p0 = paper.links;
					if (_p0.ctor === '[]') {
						return _elm_lang$html$Html$text(paper.name);
					} else {
						return A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text(paper.name),
								_1: {ctor: '[]'}
							});
					}
				}(),
				_1: {
					...
					_0: A2(
						...
						A2(
							_elm_lang$core$List$map,
							function (id) {
								var _p1 = A2(_elm_lang$core$Dict$get, id, papers);
								if (_p1.ctor === 'Nothing') {
									return _elm_lang$core$Native_Utils.crashCase(
										'Main',
										{
											start: {line: 105, column: 21},
											end: {line: 110, column: 49}
										},
										_p1)(
										A2(
									...
									return A2(_user$project$Main$viewPaper, papers, _p1._0);
								}
							},
							paper.references)),
					_1: {ctor: '[]'}
...
var _user$project$Main$init = function () {
	...
	return {
		...
		_1: A2(
			...
			A2(_elm_lang$http$Http$get, './papers.json', decodePapers))
	};
}();
